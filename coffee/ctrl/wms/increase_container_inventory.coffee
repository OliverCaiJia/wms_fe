...
.controller 'WmsIncreaseContainerInventoryCtrl', ($scope, $routeParams, WmsContainerService, WmsContainerInventoryLogService
  WmsMemberService) ->
  $scope.select = (page) ->
  ...
  $scope.increaseInventory = (containerInventoryLog) ->
