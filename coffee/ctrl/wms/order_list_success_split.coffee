...
.controller 'WmsOrderListSuccessSplitCtrl', ($scope, $routeParams, $filter, CommonService, WmsOrderService, ClickEditService
  WmsPlatformSourceService, SessionService) ->
