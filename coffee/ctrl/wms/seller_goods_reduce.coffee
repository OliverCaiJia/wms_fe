...
.controller 'WmsSellerGoodsReduceCtrl', ($scope, $routeParams, WmsMemberService,WmsSellerService,WmsSellerGoodsService
  ...
  $scope.reduceInventory = (sellerGoodsInventoryLog) ->
