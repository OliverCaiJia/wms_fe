  ...
  grunt.initConfig
    ...
    clean:
      js: [
            "<%= yeoman.dist %>/*"
#        "<%= yeoman.tmp %>/*"
        "<%= yeoman.tmp %>/js/ctrl/wms/route_index.js"
        "<%= yeoman.tmp %>/js/ctrl/wms/signin.js"
        "<%= yeoman.tmp %>/js/service/menu.js"
        "<%= yeoman.tmp %>/js/directive/nav.js"
      ]
      ...
      coffee:
        files:
          ...
          "<%= yeoman.dist %>/biz<%= yeoman.bizMd5 %>.js": [
            "<%= yeoman.tmp %>/ctrl/*.js"
            "<%= yeoman.tmp %>/ctrl/wms/*.js"
#            "<%= yeoman.tmp %>/ctrl/wms/route*.js"
          ]
          "<%= yeoman.dist %>/service<%= yeoman.bizMd5 %>.js": [
